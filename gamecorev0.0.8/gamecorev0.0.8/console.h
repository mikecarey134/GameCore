...
private:
	...
	std::map<WideString,IC_Command*> commandTable;
};
//=====================================================================================
...
public:
	...
	void setDefaults()
	{
		...
		bgColor = irr::video::SColor(150,10,10,10);
		fontColor = irr::video::SColor(200,230,230,230);
		
		fontName = "bill/console.bmp";
		prompt = ">";
...
private:
	...
	WideString& handleCommandString(WideString& wstr);
