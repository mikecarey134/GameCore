...
ChatQueue::ChatQueue(IrrlichtDevice * device,const core::rect<s32> drawArea,float textLife,bool setFade, float fadeTime, bool setShadows)
{
	ChatQueue_device = device;
...
void ChatQueue::draw()
{
	...
	if(ChatQueue_debug && ChatQueue_visible)
		ChatQueue_device->getVideoDriver()->draw2DRectangle(video::SColor(100,155,155,255),
